...
//        Stall_spDto dto = new Stall_spDto();
//        dto.setStallId(stall.getStallId());
//        dto.setStallType(stall.getStallType());  // Updated to set stallType
//        dto.setStallNumber(stall.getStallNumber());  // Updated to set stallNumber
//        dto.setSponsorId(stall.getSponsorId());
//        return dto;
//    }
//}
...
public class StallServiceImpl implements StallService {
    ...
    private Stall_spDto convertToDto(Stall_sp stall) {
        Stall_spDto dto = new Stall_spDto();
        dto.setStallId(stall.getStallId());
        dto.setStallType(stall.getStallType());
        dto.setStallNumber(stall.getStallNumber());
        dto.setSponsorId(stall.getSponsorId());
        return dto;
    }
}
